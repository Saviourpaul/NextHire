            ...
            <div class="col-auto">
                ...
                <div class="dt-search">
                    <form action="{{ url()->current() }}" method="GET"> 
                        <input type="search" class="dt-input" id="dt-search-0" name="name" placeholder="Search users..."
                            value="{{ request('name') }}"
...
<div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="search" type="text" value="{{ request('search', request('name')) }}">
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
