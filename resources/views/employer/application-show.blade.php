<x-admin-layout title="Review Application">
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="{{ route('employer.Applied-Candidates') }}" class="btn btn-outline-secondary">Back to Candidates</a>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3 flex-wrap mb-4">
                        <img class="rounded-circle" src="{{ $application->applicant->profileImageUrl() }}" alt="Profile image" width="120" height="120" style="object-fit: cover;">
                        <div>
                            <h5 class="card-title mb-1">{{ $application->first_name }} {{ $application->last_name }}</h5>
                            ...
                            <a class="ms-2" href="{{ route('applicants.profile.show', $application->applicant) }}">View linked profile</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Date of Birth:</strong> {{ $application->date_of_birth?->format('M d, Y') ?: 'Not provided' }}</p>
                            <p><strong>Gender:</strong> {{ $application->gender ? ucfirst($application->gender) : 'Not provided' }}</p>
                            <p><strong>Marital Status:</strong> {{ $application->marital_status ? ucfirst($application->marital_status) : 'Not provided' }}</p>
                            <p><strong>Nationality:</strong> {{ $application->nationality ?: 'Not provided' }}</p>
                            <p><strong>State of Origin:</strong> {{ $application->state_of_origin ?: 'Not provided' }}</p>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width: 260px;">
                                            ...
                                            >
                                                ...
                                                <input type="text" name="remarks" class="form-control form-control-sm" placeholder="Optional remarks" value="{{ old('remarks') }}">
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea name="remarks" class="form-control" rows="4" placeholder="Optional note for the applicant">{{ old('remarks', $application->employer_remarks) }}</textarea>
                        </div>
                        ...
                        @forelse ($application->statusHistories->sortByDesc('created_at') as $history)
                            <div class="list-group-item">
                                ...
                                <p class="mb-1 text-muted small">
                                    From {{ $history->from_status?->label() ?: 'New' }} by {{ $history->changedBy?->first_name ?: 'System' }}
                                </p>
                                @if ($history->remarks)
