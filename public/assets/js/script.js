...
(function($) {
	...
	// Hide loader on document ready or after 1.2s, whichever comes first
  ...
  if ($('.scroll-to-target').length) {
	...
	$('.developers-slider').each(function () {
		const $slider = $(this);
	...
	$('.feature-project-slider').each(function () {
		const $slider = $(this);
		...
		if (!$slider.hasClass('slick-initialized')) {
			$slider.slick({
				...
				responsive: [
					{
						breakpoint: 1190,
						settings: { slidesToShow: 5, slidesToScroll: 1, dots: false }
					},
					{
						breakpoint: 992,
						settings: { slidesToShow: 3, slidesToScroll: 1, dots: false }
		...
		if (!$slider.hasClass('slick-initialized')) {
			$slider.slick({
				...
				responsive: [
					{
						breakpoint: 1190,
						settings: { slidesToShow: 5, slidesToScroll: 1, dots: false, arrows: false }
					},
					{
						breakpoint: 992,
						settings: { slidesToShow: 3, slidesToScroll: 1, dots: false, arrows: false }
					},
					{
						breakpoint: 768,
		...
		if (!$slider.hasClass('slick-initialized')) {
			$slider.slick({
				...
				responsive: [
					{
						breakpoint: 1190,
						settings: { slidesToShow: 3, slidesToScroll: 1, dots: false, arrows: true }
					},
					{
						breakpoint: 992,
						settings: { slidesToShow: 3, slidesToScroll: 1, dots: false, arrows: true }
					...
					{
						breakpoint: 768,
						settings: { slidesToShow: 2, slidesToScroll: 1, dots: false, arrows: true }
					},
					{
						breakpoint: 576,
